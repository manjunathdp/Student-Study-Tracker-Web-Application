...
<?php
    ...
    ?>
        ...
        <?php $daterev=" select sum(hours) as today from details where date='$Date' and subject='DBMS';";
        ...
        <th>HOURS</th></tr>
        <?php
        $ret2="select DATE_FORMAT(date ,'%M (%Y)') as month,sum(hours) as hrs from details WHERE subject='DBMS' group by month;";
