<html>
    ...
    <body>
    <center><h1>System Software</h1></center>       
    
<?php
include("connection.php");

$ret2="select * from details where subject='SS';";
...
<?php
    ...
    ?>
        ...
        <?php $daterev=" select sum(hours) as today from details where date='$Date' and subject='SS';";
        ...
        <th>HOURS</th></tr>
        <?php
        $ret2="select DATE_FORMAT(date ,'%M (%Y)') as month,sum(hours) as hrs from details WHERE subject='SS' group by month;";
