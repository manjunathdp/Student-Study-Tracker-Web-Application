...
$ret2="select * from details where subject='DSA';";
...
<?php
    ...
    ?>
        ...
        <?php $daterev=" select sum(hours) as today from details where date='$Date' and subject='DSA';";
        ...
        <th>HOURS</th></tr>
        <?php
        $ret2="select DATE_FORMAT(date ,'%M (%Y)') as month,sum(hours) as hrs from details WHERE subject='DSA' group by month;";
