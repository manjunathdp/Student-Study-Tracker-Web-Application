...
$ret2="select * from details where subject='NLP';";

$dbrt=mysqli_query($conn,$ret2);

?>

<center><h1>Natural Language Processing</h1></center>
...
<?php
    ...
    ?>
        ...
        <?php $daterev=" select sum(hours) as today from details where date='$Date' and subject='NLP';";
        ...
        <th>HOURS</th></tr>
        <?php
        $ret2="select DATE_FORMAT(date ,'%M (%Y)') as month,sum(hours) as hrs from details WHERE subject='NLP' group by month;";
