...
$ret2="select * from details where subject='CN1';";

$dbrt=mysqli_query($conn,$ret2);

?>

<center><h1>Computer Networks-1</h1></center>
...
<?php
    ...
    ?>
        ...
        <?php $daterev=" select sum(hours) as today from details where date='$Date' and subject='CN1';";
        ...
        <th>HOURS</th></tr>
        <?php
        $ret2="select DATE_FORMAT(date ,'%M (%Y)') as month,sum(hours) as hrs from details WHERE subject='CN1' group by month;";
